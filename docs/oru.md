...
##Scrum-Protokolle
Die Scrum Protokolle können unter diesem [Link](dokumente_/Scrum_Protokoll) als PDF aufgerufen werden. Dort befindet sich weitere Informationen bezüglich der organisatorischen Umsetzung von unserem Projekt.


##Planung
Wir haben uns entschieden, unseren Code in vier klare Blöcke zu unterteilen: Frontend, Backend, Logik und Tests. Die Aufteilung kann im Bereich "Technische Umsetzung - Aufbau vom Programm" gefunden werden.
Zudem haben wir geplant alle geforderten Funktionen auf jeweilige Branches zu entwickeln und diese dann auf einen separaten Branch (developer) zu mergen. 
...
- Fehlermeldungen werden über Pop-Ups angezeigt
...
[Sneakcase](https://www.freecodecamp.org/news/snake-case-vs-camel-case-vs-pascal-case-vs-kebab-case-whats-the-difference/)(3.12.2025)
